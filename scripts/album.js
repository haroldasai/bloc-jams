...
/*Code by Harold
 var findParentByClassName = function(classname, object) {
...
var findParentByClassName = function(element, targetClass) {
    if (element) {
        ...
        if(currentParent === null){
            ...
            while (currentParent !== null && ((currentParent.className !== targetClass && currentParent.className !== null) || currentParent.className === null)) {
